...
# Generated: Thu May 31 16:36:58 2012
##################################################
...
class funcube_test(grc_wxgui.top_block_gui):
	...
	def __init__(self):
		...
		self.GridAdd(self.wxgui_histosink2_0.win, 0, 2, 5, 2)
		...
		self.GridAdd(self.fftsink.win, 0, 0, 5, 2)
		...
		self.connect((self.gr_nlog10_ff_0, 0), (self.wxgui_histosink2_0, 0))
